<?php
  ...
  $sql = "UPDATE MyDB.circleOfFriends SET "
  . "circleOfFriendsName=" . wrapArgument( htmlspecialchars($_POST['circleOfFriendsName']))
  . " WHERE circleFriendsId=" . htmlspecialchars($_POST['circleFriendsId']);
