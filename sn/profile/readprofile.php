				...
				<div id="pictures" class="tab-pane">
					...
					<?php
                            ...
                            foreach ($q1->fetchAll() as $row) {
                                ...
                                $privacy = $row['privacy'];
                                if($loggedInUser!=$email){ //we only care about privacy settings of the photo collection if the owner is not the currently logged in user
                                    if($privacy=='Only me'){
                                            continue;
                                        ...
                                        if($count>0) { 
                                            //is a friend of collection owner, so allowed to see this album
                                        }else{
                                            continue;
                                        }
                                    }else{//anybody
